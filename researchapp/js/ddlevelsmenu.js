...
rightarrowpointer: ["../images/arrow_submenu.gif", 10,7], //path to "right arrow" image that gets added to LI elements within drop down menu containing additional menus
